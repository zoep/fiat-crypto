...
pub fn fiat_25519_carry_mul(out1: &mut [u64; 5], arg1: &[u64; 5], arg2: &[u64; 5]) -> () {
    let x1: fiat_25519_u128 =
        (((arg1[4]) as fiat_25519_u128) * (((arg2[4]) * ((0x13 as u8) as u64)) as fiat_25519_u128));
    let x2: fiat_25519_u128 =
        (((arg1[4]) as fiat_25519_u128) * (((arg2[3]) * ((0x13 as u8) as u64)) as fiat_25519_u128));
    let x3: fiat_25519_u128 =
        (((arg1[4]) as fiat_25519_u128) * (((arg2[2]) * ((0x13 as u8) as u64)) as fiat_25519_u128));
    let x4: fiat_25519_u128 =
        (((arg1[4]) as fiat_25519_u128) * (((arg2[1]) * ((0x13 as u8) as u64)) as fiat_25519_u128));
    let x5: fiat_25519_u128 =
        (((arg1[3]) as fiat_25519_u128) * (((arg2[4]) * ((0x13 as u8) as u64)) as fiat_25519_u128));
    let x6: fiat_25519_u128 =
        (((arg1[3]) as fiat_25519_u128) * (((arg2[3]) * ((0x13 as u8) as u64)) as fiat_25519_u128));
    let x7: fiat_25519_u128 =
        (((arg1[3]) as fiat_25519_u128) * (((arg2[2]) * ((0x13 as u8) as u64)) as fiat_25519_u128));
    let x8: fiat_25519_u128 =
        (((arg1[2]) as fiat_25519_u128) * (((arg2[4]) * ((0x13 as u8) as u64)) as fiat_25519_u128));
    let x9: fiat_25519_u128 =
        (((arg1[2]) as fiat_25519_u128) * (((arg2[3]) * ((0x13 as u8) as u64)) as fiat_25519_u128));
    let x10: fiat_25519_u128 =
        (((arg1[1]) as fiat_25519_u128) * (((arg2[4]) * ((0x13 as u8) as u64)) as fiat_25519_u128));
